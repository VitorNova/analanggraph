...
FLOW_DEFINITIONS = {
    "webhook": {
        "nodes": [
            {"id": "buffer_9s",         "label": "Buffer 9s",              "x": 400, "y": 50,   "icon": "timer"},
            {"id": "pause_check",       "label": "Verif. Pausa",           "x": 400, "y": 140,  "icon": "pause"},
            {"id": "queue_check",       "label": "Verif. Fila",            "x": 400, "y": 230,  "icon": "queue"},
            {"id": "historico",         "label": "Historico",              "x": 400, "y": 320,  "icon": "history"},
            {"id": "transcricao",       "label": "Transcricao",            "x": 650, "y": 320,  "icon": "mic"},
            {"id": "context_detection", "label": "Detectar Contexto",      "x": 400, "y": 410,  "icon": "search"},
            {"id": "ai_agent",          "label": "Agente IA (Gemini)",     "x": 400, "y": 500,  "icon": "robot"},
            {"id": "tool_consultar",    "label": "Consultar Cliente",      "x": 150, "y": 600,  "icon": "lookup"},
            {"id": "tool_transferir",   "label": "Transferir Dept.",       "x": 400, "y": 600,  "icon": "transfer"},
            {"id": "tool_compromisso",  "label": "Registrar Compromisso",  "x": 650, "y": 600,  "icon": "calendar"},
            {"id": "guardrail",         "label": "Validacao",              "x": 400, "y": 700,  "icon": "shield"},
            {"id": "enviar_resposta",   "label": "Enviar Resposta",        "x": 400, "y": 790,  "icon": "send"},
            {"id": "salvar_historico",  "label": "Salvar Historico",       "x": 400, "y": 880,  "icon": "save"},
        ],
        "edges": [
